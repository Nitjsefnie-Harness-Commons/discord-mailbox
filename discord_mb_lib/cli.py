...
def _cli():
    ...
    mg_rd = mg_sub.add_parser('reactions', help='Read the reactions on a message')
    mg_rd.add_argument('msg_id')
    mg_rd.add_argument('--channel', dest='channel', required=True, help='Channel id/name the message lives in')
    mg_rd.add_argument('--json', action='store_true', help='Emit the raw reaction records')
